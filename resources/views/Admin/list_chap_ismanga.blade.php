...
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active"><a href="{{route('admin.manga')}}">list-truyen</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Danh sách chapter - truyện <span style="font-weight: bolder;color: magenta;">{{$value->Ten_truyen}}</span></h3>
                @break;
                @endforeach
